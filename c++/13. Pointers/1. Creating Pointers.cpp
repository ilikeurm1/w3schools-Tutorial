...
int main() {
    ...
    */
    ...
    cout << &food << "\n"; // Outputs the memory address of food (0x5ffe60)
    ...
    */
    ...
    // Output the memory address of food (0x5ffe60)
    cout << &food << "\n";

    // Output the memory address of food with the pointer (0x5ffe60)
    cout << ptr << "\n";

    /* Example explained
    Create a pointer variable with the name ptr, that points to a string variable,
    by using the asterisk sign * (string* ptr). Note that the type of the pointer has to match the type of the variable you're working with.
